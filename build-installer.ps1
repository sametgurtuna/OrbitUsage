# Build script for Orbit v0.2.0 Setup Installer
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  Building Orbit v0.2.0 Release & Setup " -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
...
if ($iscc) {
    ...
    if ($LASTEXITCODE -eq 0) {
        Write-Host "`n[SUCCESS] Setup installer generated at: installer\output\OrbitSetup-v0.2.0.exe" -ForegroundColor Green
    } else {
